...
def main(isTest):
    ...
    content, postTitle, articleLink = getcontent.getcontent(isTest)
    ...
    postBody = format.postBody(saleArray, bannerLink, articleLink)
    ...
    if isTest:
        ...
        r.submit(settings.subreddit, getcontent.postTitle, text=postBody)
